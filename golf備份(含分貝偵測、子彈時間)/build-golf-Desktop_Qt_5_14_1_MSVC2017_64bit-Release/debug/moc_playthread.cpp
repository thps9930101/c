...
#include <memory>
#include "../../golf/tool/playthread.h"
...
void PlayThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (PlayThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayThread::nextFrame)) {
                *result = 0;
                return;
            }
        }
