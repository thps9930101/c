#ifndef OUTPUT_RTMP_H
#define OUTPUT_RTMP_H
...
public:
    ...
    int create(const char *output_rtmp, Encoder_param en_par,AVCodecContext *Context);
...
private:
    ...
    double v_pkt_duration;

    int64_t v_rtmp_cnt = 0;
