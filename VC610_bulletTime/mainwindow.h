...
private:
    ...
    void startPlayback();
    void stopPlayback();
    bool ensureDirectoryExists(const QString &);
    bool moveFileWithDir(const QString &, const QString &);
...
//    SP_MODE SP_mode;
    ...
    bool VideoLoop = false; // 防止同時重入
    QList<QString> MasterIPArray;
    QString videoPath;
    QString videoDir;
    bool checkOutputPath = false;
protected:
...
private slots:
    ...
    void on_bt_bt_clicked();
    void on_bt_vid_bt_clicked();
    void on_bt_vid_bt_2_clicked();
    void on_og_vid_bt_clicked();
};
